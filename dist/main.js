...
class DefaultList {
  ...
  constructor(data) {
    ...
    _PubSub__WEBPACK_IMPORTED_MODULE_0__.PubSub.on("TaskIsReadyForEditing", this.editTask.bind(this));
    _PubSub__WEBPACK_IMPORTED_MODULE_0__.PubSub.on("UserWantsToDeleteTask", this.deleteTask.bind(this));
  }
...
class TaskRenderer {
  ...
  renderTask(parentListDiv, task) {
    ...
    taskDueDate.textContent = (0,date_fns_formatDistanceToNow__WEBPACK_IMPORTED_MODULE_0__["default"])(task.dueDate);
    taskDueDate.classList.add("due-date");
    if ((0,date_fns_isFuture__WEBPACK_IMPORTED_MODULE_1__["default"])(task.dueDate)) {
...
class Task {
  ...
  constructor(taskData) {
    ...
    this.EditTaskButton.addEventListener("click", () => {
      _PubSub__WEBPACK_IMPORTED_MODULE_0__.PubSub.emit("UserWantsToEditTask", this);
      _PubSub__WEBPACK_IMPORTED_MODULE_0__.PubSub.emit("OpenForm", _form_manager__WEBPACK_IMPORTED_MODULE_1__.FORM_REGISTRY.task);
    });
